...
## Instalation
> [!NOTE]
> Replace "0.0.7" with ![](https://img.shields.io/maven-central/v/io.github.phansier.h3/library?label=latest%20version)
...
kotlin {
   sourceSets {
      commonMain.dependencies {
            implementation("io.github.phansier.h3:library:0.0.7")
            /*
